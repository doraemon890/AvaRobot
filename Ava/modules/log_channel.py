...
if is_module_loaded(FILENAME):
    ...
    from Ava import EVENT_LOGS, LOGGER, dispatcher
    ...
    from Ava.modules.sql import log_channel_sql as sql
...
@Avacallback(pattern=r"log_tog_.*")

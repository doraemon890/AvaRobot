...
@Jarvis.on_message(filters.command("unpinall") & ~filters.private)
...
@Jarvis.on_message(filters.command("antichannelpin") & ~filters.private)
...
@Jarvis.on_message(filters.command("cleanlinked") & ~filters.private)
...
@Jarvis.on_message(filters.command("permapin") & ~filters.private)
...
@Jarvis.on_message(filters.linked_channel)

...
import Ava.modules.sql.antilinkedchannel_sql as sql
from Ava import SUPPORT_CHAT, TOKEN, dispatcher
from Ava.modules.helper_funcs.anonymous import AdminPerms, user_admin
from Ava.modules.helper_funcs.chat_status import bot_admin, bot_can_delete
...
from Ava.modules.sql import acm_sql


@Avacmd(command="antilinkedchan", group=112)
@bot_can_delete
...
@Avamsg(Filters.is_automatic_forward, group=111)
...
@Avacmd(command="antichannelpin", group=114)
@bot_admin
@user_admin(AdminPerms.CAN_RESTRICT_MEMBERS)
...
@Avamsg(Filters.is_automatic_forward | Filters.status_update.pinned_message, group=113)
def eliminate_linked_channel_msg(update: Update, _: CallbackContext):
    message = update.effective_message
    chat = update.effective_chat

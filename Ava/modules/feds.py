...
import Ava.modules.sql.feds_sql as sql
from Ava import (
    DRAGONS,
    EVENT_LOGS,
    LOGGER,
    ...
    if args:
        if args[0] == "json":
            ...
            with BytesIO(str.encode(backups)) as output:
                output.name = "Ava_fbanned_users.json"
                update.effective_message.reply_document(
                    document=output,
                    filename="Ava_fbanned_users.json",
        ...
        if args[0] == "csv":
            ...
            for users in getfban:
                ...
                backups += "\n"
            with BytesIO(str.encode(backups)) as output:
                output.name = "Ava_fbanned_users.csv"
                update.effective_message.reply_document(
                    document=output,
                    filename="Ava_fbanned_users.csv",

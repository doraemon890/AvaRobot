...
from Ava.modules.cron_jobs import j
from Ava.modules.helper_funcs.anonymous import AdminPerms
from Ava.modules.helper_funcs.anonymous import resolve_user as res_user
from Ava.modules.helper_funcs.anonymous import user_admin as u_admin
from Ava.modules.helper_funcs.chat_status import connection_status, user_admin_no_reply
...
@Avacmd(command="raid", pass_args=True)
@connection_status
@loggable
...
@Avacallback(pattern="enable_raid=")
@connection_status
@user_admin_no_reply
@loggable
...
@Avacallback(pattern="disable_raid=")
@connection_status
@user_admin_no_reply
@loggable
...
@Avacallback(pattern="cancel_raid=")
@connection_status
@user_admin_no_reply
...
@Avacmd(command="raidactiontime", pass_args=True)
@connection_status
@u_admin(AdminPerms.CAN_CHANGE_INFO)
@loggable
def raidtime(update: Update, context: CallbackContext) -> Optional[str]:

...
from Ava.modules.no_sql.karma_db import (
    alpha_to_int,
    get_karma,
    get_karmas,
    int_to_alpha,
...
regex_downvote = r"^(\-|\-\-|\-1|👎|💔|noob|weak|fuck off|nub|gay|kid|shit|mf)$"
...
@app.on_cmd("karmastat", group_only=True)
@app.adminsOnly(permissions="can_change_info", is_both=True)
...
@app.on_cmd("karma", group_only=True)
@app.adminsOnly(permissions="can_change_info", is_both=True)

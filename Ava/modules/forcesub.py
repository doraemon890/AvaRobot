...
from Ava import BOT_ID
from Ava import DRAGONS as DEVS
from Ava import OWNER_ID
from Ava import telethn as tbot
from Ava.events import Uvinline
from Ava.events import register as uvbot
from Ava.modules.no_sql import fsub_db as db
...
@uvbot(pattern="^/(fsub|Fsub|forcesubscribe|Forcesub|forcesub|Forcesubscribe) ?(.*)")

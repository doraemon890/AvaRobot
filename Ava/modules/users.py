...
import Ava.modules.no_sql.users_db as user_db
from Ava import DEV_USERS, LOGGER, OWNER_ID, dispatcher
from Ava.modules.helper_funcs.chat_status import dev_plus, sudo_plus
from Ava.modules.helper_funcs.decorators import Avacmd, Avamsg
from Ava.modules.no_sql.users_db import get_all_users
...
@Avacmd(command=["broadcastall", "broadcastusers", "broadcastgroups"])
@dev_plus
...
@Avamsg((Filters.all & Filters.chat_type.groups), group=USERS_GROUP)
...
@Avamsg((Filters.all & Filters.chat_type.groups), group=CHAT_GROUP)

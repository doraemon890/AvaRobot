...
from Ava import DRAGONS, LOGGER, TIGERS, WOLVES
...
from Ava.modules.sql import reporting_sql as sql
...
@Avacmd(command="report", filters=Filters.chat_type.groups, group=REPORT_GROUP)
@Avamsg((Filters.regex(r"(?i)@admin(s)?")), group=REPORT_GROUP)
@user_not_admin
@loggable

...
from Ava.utils import aiodownloader
from Ava.utils.dbfunctions import start_restart_stage
from Ava.utils.fetch import fetch
...
async def restart(m: Message):
    ...
    execvp(executable, [executable, "-m", "Ava"])
